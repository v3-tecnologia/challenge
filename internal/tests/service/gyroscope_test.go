...
// 	d "v3/internal/domain/gyroscope"
// 	"v3/internal/service/gyroscope"
...
// func (m *MockGyroscopeRepository) Create(data *d.Gyroscope) (*d.Gyroscope, error) {
// 	args := m.Called(data)
// 	return args.Get(0).(*d.Gyroscope), args.Error(1)
// }
