...
func NewPhotoController(s service.PhotoServiceInterface) *PhotoController {
	return &PhotoController{Service: s}
}

func (c *PhotoController) CreatePhoto(w http.ResponseWriter, r *http.Request) {
...
func (c *PhotoController) GetPhoto(w http.ResponseWriter, r *http.Request) {
